	...
	class Old_Post_Notice_Nag {
		...
		public function display() {
			...
			if ( true == $display_nag ) {
				...
				echo '<div class="notice notice-success"><p>' . sprintf( esc_html__( 'Hello! I\'m David. I develop this plugin in my spare time. If it has helped you, please consider %1$s (one-time or monthly) and/or %2$s. This helps me commit more time to development and keeps it free. You can disable this nag in %3$s.', 'old-post-notice' ), '<a href="https://github.com/sponsors/medavidallsop" target="_blank">' . esc_html__( 'sponsoring me on GitHub', 'old-post-notice' ) . '</a>', '<a href="https://wordpress.org/support/plugin/old-post-notice/reviews/" target="_blank">' . esc_html__( 'leaving a review', 'old-post-notice' ) . '</a>', '<a href="' . esc_url( get_admin_url() . 'options-general.php?page=old-post-notice' ) . '">' . esc_html__( 'settings', 'old-post-notice' ) . '</a>' ) . '</p></div>';
